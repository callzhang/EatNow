...
- (UITableViewCell *)cellForRow {
    ...
    //TODO: make it work!!
//    @weakify(self);
//    [self.KVOControllerNonRetaining observe:self keyPath:@keypath(self.configurator, date) options:NSKeyValueObservingOptionInitial|NSKeyValueObservingOptionNew block:^(id observer, id object, NSDictionary *change) {
//        @strongify(self);
//        if ([cell isKindOfClass:[TMDatePickerTableViewCell class]]) {
...
- (void)setExpand:(BOOL)expand {
    ...
    if (self.didExpandChangeHandler) {
        self.didExpandChangeHandler(self);
    }
}
