...
- (void)layoutSubviews {
    ...
    if (_showTopSeparator) {
        ...
        _topSeparator.frame = CGRectMake(_topSeparatorLeftInset, 0.0, cellWidth - _topSeparatorRightInset, separatorHeight);
    ...
    if (_showBottomSeparator) {
        ...
        _bottomSeparator.frame = CGRectMake(_bottomSeparatorLeftInset, cellHeight-separatorHeight, cellWidth - _bottomSeparatorRightInset - _bottomSeparatorLeftInset, separatorHeight);
