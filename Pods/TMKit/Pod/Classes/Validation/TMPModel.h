...
FOUNDATION_EXPORT NSString *const TMPModelValidatorAttributes;
FOUNDATION_EXPORT NSString *const TMPModelValidatorType;
FOUNDATION_EXPORT NSString *const TMPModelValidatorOn;
FOUNDATION_EXPORT NSString *const TMPModelValidatorExcept;
FOUNDATION_EXPORT NSString *const TMPModelValidatorWhen;
FOUNDATION_EXPORT NSString *const TMPModelValidatorSkipOnError;
FOUNDATION_EXPORT NSString *const TMPModelValidatorSkipOnEmpty;
FOUNDATION_EXPORT NSString *const TMPModelValidatorMessage;
FOUNDATION_EXPORT NSString *const TMPModelValidatorIsEmpty;
FOUNDATION_EXPORT NSString *const TMPModelValidatorAction;
FOUNDATION_EXPORT NSString *const TMPModelValidatorTrueValue;
FOUNDATION_EXPORT NSString *const TMPModelValidatorFalseValue;
FOUNDATION_EXPORT NSString *const TMPModelValidatorCompareAttribute;
FOUNDATION_EXPORT NSString *const TMPModelValidatorCompareValue;
FOUNDATION_EXPORT NSString *const TMPModelValidatorOperator;
FOUNDATION_EXPORT NSString *const TMPModelValidatorValue;
FOUNDATION_EXPORT NSString *const TMPModelValidatorCheckDNS;
FOUNDATION_EXPORT NSString *const TMPModelValidatorEnableIDN;
FOUNDATION_EXPORT NSString *const TMPModelValidatorFilter;
FOUNDATION_EXPORT NSString *const TMPModelValidatorSkipOnArray;
FOUNDATION_EXPORT NSString *const TMPModelValidatorTooBig;
FOUNDATION_EXPORT NSString *const TMPModelValidatorTooSmall;
FOUNDATION_EXPORT NSString *const TMPModelValidatorMin;
FOUNDATION_EXPORT NSString *const TMPModelValidatorMax;
FOUNDATION_EXPORT NSString *const TMPModelValidatorRange;
FOUNDATION_EXPORT NSString *const TMPModelValidatorAllowArray;
FOUNDATION_EXPORT NSString *const TMPModelValidatorNot;
FOUNDATION_EXPORT NSString *const TMPModelValidatorPattern;
FOUNDATION_EXPORT NSString *const TMPModelValidatorRequiredValue;
FOUNDATION_EXPORT NSString *const TMPModelValidatorLength;
FOUNDATION_EXPORT NSString *const TMPModelValidatorTooShort;
FOUNDATION_EXPORT NSString *const TMPModelValidatorTooLong;
FOUNDATION_EXPORT NSString *const TMPModelValidatorNotEqual;
FOUNDATION_EXPORT NSString *const TMPModelValidatorValidSchemes;
FOUNDATION_EXPORT NSString *const TMPModelValidatorDefaultScheme;
FOUNDATION_EXPORT NSString *const TMPModelValidatorSet;
#pragma clang diagnostic pop

@protocol TMPModel <NSObject>
@optional
...
* [TMPModelRequiredValidator] validation rule in the current [[scenario]].
*
* Note that when the validator has a conditional validation applied using
* TMPModelValidatorWhen this method will return
* "NO" regardless of the TMPModelValidatorWhen condition because it may be called be
...
@interface TMPModelWrapper : NSObject
@end