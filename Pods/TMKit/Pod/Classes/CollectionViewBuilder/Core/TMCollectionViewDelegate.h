...
@interface TMCollectionViewDelegate : NSObject <UICollectionViewDelegateFlowLayout>
@property (nonatomic, weak) TMCollectionViewBuilder *collectionViewBuilder;
@property (nonatomic, weak) NSObject<UICollectionViewDelegateFlowLayout> *forwardDelegate;
