...
- (void)setForwardDelegate:(NSObject<UICollectionViewDelegateFlowLayout> *)forwardDelegate {
    self.delegate.forwardDelegate = forwardDelegate;
}

- (NSObject<UICollectionViewDelegateFlowLayout> *)forwardDelegate {
    return self.delegate.forwardDelegate;
}
