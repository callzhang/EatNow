...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'Pods/AMRatingControl.framework'
  ...
  install_framework 'Pods/JCTagListView.framework'
  ...
  install_framework 'Pods/UITableView_NXEmptyView.framework'
  install_framework 'Pods/WeixinActivity.framework'
  install_framework 'Pods/apptentive_ios.framework'
